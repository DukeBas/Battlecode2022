...
public class Sage extends Robot {
    ...
    private final static double ENEMY_COUNTING_FACTOR_AGGRESSIVE = 1.2; // when comparing friendly to enemy numbers
    private final static double ENEMY_COUNTING_FACTOR_SKIRMISH = 3; // when comparing friendly to enemy numbers
    ...
    void run() throws GameActionException {
         ...
         *      This is in the hope that more allies will reinforce us, so our combat units stick together.
        ...
        int maxHP = RobotType.SAGE.getMaxHealth(1);
        if (needToHeal) { // we previously found out we needed to heal, are we back to full already?
            ...
            if (attacking) { // attack signal! do not retreat easily!
                ...
                needToHeal = rc.getHealth() < maxHP * 0.6;
            }
        }
